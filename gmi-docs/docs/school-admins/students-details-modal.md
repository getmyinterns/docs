...
![Student Details](images/students-details-modal-workflow.png)

There is a **_Notes_** tab to allow you to freely enter any text you may need. The system keeps track of the dates and persons entering those notes.

![Student Details](images/students-details-modal-notes.png)
...
You can toggle between `Seasons` and choose to filter by different statuses.

![Student Details](images/students-details-modal-internships.png)

On the `Seasons` tab, you can see the `Student`'s status for active `Seasons`, and approve or decline the `Student`.

![Student Details](images/students-details-modal-seasons.png)

You can see the `Student`'s **_Interview Availability_** for the active `Seasons` on the last tab.

![Student Details](images/students-details-modal-availability.png)
